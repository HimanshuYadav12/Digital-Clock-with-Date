...
lbl_date.place(x=350,y=430,width=150,height=50)
...
lbl_month.place(x=520,y=430,width=150,height=50)
...
lbl_year.place(x=690,y=430,width=150,height=50)
...
lbl_current_date.place(x=860,y=430,width=150,height=50)
clock()
root.mainloop()